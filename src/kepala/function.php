...
if(isset($_POST['tambahadmin'])){
    ...
    $addadmin = mysqli_query($conn, "INSERT INTO user (nama_lengkap, alamat, ttl) values('$namalengkap', '$alamat', '$ttl')");
    if($addadmin){
...
if(isset($_POST['updateadmin'])){
    ...
    $queryupdate=mysqli_query($conn, "update user set nama_lengkap='$namalengkapbr',ttl='$ttlbr',alamat='$alamatbr' where id ='$id'");
    if($queryupdate){
        header('location:admin.php');
    }else{
        echo 'gagal input';
