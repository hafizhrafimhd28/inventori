                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <table id="datatablesSimple" width="100%" cellspacing="1">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambildatamasuk = mysqli_query($conn, "select * from brgmasuk where idbarang='$idbarang' and status='1'");
                                        $i=1;
                            ...
                            <div class = "table-responsive">
                                <table class="table table-bordered" id="detailkeluar" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambildatakeluar = mysqli_query($conn, "select * from brgkeluar where idbarang='$idbarang' and status='1'");
                                        $i=1;
