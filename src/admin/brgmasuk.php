                            ...
                            <table id="datatablesSimple" width="100%" cellspacing="1">
                                    ...
                                    if(isset($_POST['filtertgl'])){
                                            ...
                                            if($tanggalmulai!=NULL || $tanggalselesai!=NULL){
                                                $ambilsemuadatastock = mysqli_query($conn,"select * from brgmasuk m, stockbrg s where s.idbarang = m.idbarang and tanggal BETWEEN '$tanggalmulai' and DATE_ADD('$tanggalselesai', INTERVAL 1 DAY) order by idmasuk DESC");
                                            }else {
                                                $ambilsemuadatastock = mysqli_query($conn,"select * from brgmasuk m, stockbrg s where s.idbarang = m.idbarang order by idmasuk DESC");
                                            }
                                        }else {
                                            $ambilsemuadatastock = mysqli_query($conn,"select * from brgmasuk m, stockbrg s where s.idbarang = m.idbarang order by idmasuk DESC");
                                        }  
                                        ...
                                        <tr>
                                            ...
                                            $tempdir = "temp/"; 
                                            $namafile = "barangmasuk".$idm.".png";
                                            if (!file_exists($tempdir))
                                            mkdir($tempdir);
                                            $kode = "qrcode /".$idm."/". $namabarang."";
                                            ...
                                            <td><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit<?=$idm;?>">
                                                ...
                                                <input type="hidden" name="editbarang" value="<?=$idm;?>"> 
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?=$idm;?>">
                                                Delete
                                                </button>
                                                <br>
                                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#konfirmasi<?=$idm;?>">
                                                Konfirmasi
                                                <input type="hidden" name="konfirmasibarangmasuk" value="<?=$idm;?>">
                                                </button>
                                                <a href="exportbrgmasuk.php?id=<?=$idm?>"><button class="download">Cetak</button></a>
                                        ...
                                        <div class="modal fade" id="edit<?=$idm;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <br>
                                                <input type="number" name="qty" value="<?=$qty;?>" class="form-control" placeholder="Banyak Barang" required>
                                        ...
                                        <!-- The Modal -->
                                        <div class="modal fade" id="konfirmasi<?=$idm;?>">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form method="post">
                                                <div class="modal-body">
                                                Apakah anda yakin ingin konfirmasi Pemasukan Barang oleh <?=$admin;?><br><br>
                                                <input type="hidden" name="idb" value="<?=$idb;?>">
                                                <input type="hidden" name="idm" value="<?=$idm;?>">
                                                <button type="submit" class="btn btn-danger" name="konfirmasibarangmasuk">Konfirmasi</button>
                                                </div>
                                                </form>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <select name="barangnya" class="form-control">
          ...
          <button type="submit" class="btn btn-primary" name="barangmasuk">Tambah</button>
        </div>
        </form>
