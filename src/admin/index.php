                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <?php
                                $ambildatastock = mysqli_query($conn, "select * from stockbrg where stock < 1");
                            ...
                            ?>
                                <div class="alert alert-warning alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                                    <strong>Perhatian!</strong> Stock Barang <?=$barang;?> Tinggal sedikit.
                                </div>
                            <?php
                            }
                            ?>
                            <div class = "table-responsive">
                                <table id="datatablesSimple" width="100%" cellspacing="1">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambilsemuadatastock = mysqli_query($conn,"select * from stockbrg");
                                        $i = 1;
                                        ...
                                        <tr>
                                            ...
                                            $tempdir = "temp/"; 
                                            $namafile = "barang".$idb.".png";
                                            if (!file_exists($tempdir))
                                            mkdir($tempdir);
                                            $kode = "qrcode /".$idb."/". $namabarang."";
                                            ...
                                            <td><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit<?=$idb;?>">
                                                ...
                                                <input type="hidden" name="editbarang" value="<?=$idb;?>"> 
